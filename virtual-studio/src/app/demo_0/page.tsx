...
export default async function Demo0HomePage() {
  ...
  return (
    <>
      <div className="home-hero">
        <p className="home-eyebrow">Virtual Studio · v0.1 (demo_0 备份)</p>
      ...
      <div className="module-grid">
        <Link className="module-card wide" href="/demo_0/archive">
        ...
        <Link className="module-card" href="/demo_0/aievolutionlog">
        ...
        <Link className="module-card" href="/demo_0/lab">
        ...
        <Link className="module-card" href="/demo_0/workflow">
          <span className="mc-emoji">⚙️</span>
        ...
        <Link className="module-card" href="/demo_0/pause">
          <span className="mc-emoji">🌿</span>
        ...
        <Link className="module-card" href="/demo_0/changelog">
          <span className="mc-emoji">📋</span>
        ...
        <Link className="module-card" href="/demo_0/archive?tab=notes">
          <span className="mc-emoji">🗒️</span>
